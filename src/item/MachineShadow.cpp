...
MachineShadow::MachineShadow(QGraphicsScene* scene):scene(scene),rect(nullptr),arrow(nullptr),group(nullptr)
{
	is_setup=false;
}
...
//    rect->setRotation(90+rect->rotation());
//    arrow->setRotation(90+arrow->rotation());
	this->rotate_count++;
}

void MachineShadow::destory() {
    group->setPos(64*44+100,64*44+100);
//    rect->setPos(64*44+100,64*44+100);
